...
const ReviewCard = ({ stars, name, platform, content, isLocalGuide = false }: { stars: number; name: string; platform: string; content: string; isLocalGuide?: boolean }) => (
  <div className="bg-white p-8 rounded-2xl border border-zinc-100 shadow-sm flex flex-col h-full">
    <div className="flex gap-1 mb-4">
      {[...Array(stars)].map((_, i) => (
        <Star key={i} className="w-4 h-4 fill-[#F8ABAC] text-[#F8ABAC]" />
      ))}
    </div>
...
export default function HolidayLightingQualicumBeach() {
  const schema = {
    ...
    "@graph": [
      {
        ...
        "image": "https://picsum.photos/seed/qualicum-lights/800/600",
        "@id": "https://coastalville.ca/holiday-lighting-qualicum-beach",
        "url": "https://coastalville.ca/holiday-lighting-qualicum-beach",
      ...
      },
      {
        ...
        "description": "Professional holiday light installation, takedown and storage in Qualicum Beach BC. Halloween + Christmas package available."
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          {
            "@type": "Question",
            "name": "When should Qualicum Beach homeowners book holiday lighting?",
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "As early as possible, ideally by September. Our fall schedule covers Qualicum Beach alongside Parksville and fills up fast. Most years we're fully booked by mid-October. If you're thinking about it, reach out now and get on the list."
            }
          },
          {
            "@type": "Question",
          ...
          {
            "@type": "Question",
            "name": "Do you serve areas outside Qualicum Beach?",
            "acceptedAnswer": {
              "@type": "Answer",
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-[#033852]">
      <SEO 
        title="Holiday Light Installation Qualicum Beach BC | CoastalVille Exteriors"
        description="Professional holiday light installation, takedown and storage in Qualicum Beach BC. Free lighting consult and mockup at your home. Halloween + Christmas package available. From $500. Call (250) 270-1010."
        schema={schema}
      />
      <Navbar />
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <motion.img 
            ...
            alt="Festive holiday lighting installation in Qualicum Beach" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="max-w-xl text-white/80 text-sm md:text-base font-medium leading-relaxed mb-12">
              Design, installation, takedown and storage, all included. Free lighting consult and mockup at your Qualicum Beach home. From $500.
            </p>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-[#033852] mb-8 leading-tight">Holiday Lighting in Qualicum Beach</h2>
          <div className="space-y-6 text-zinc-600 text-lg leading-relaxed">
            <p>
              CoastalVille Exteriors is a Parksville-based exterior company serving Qualicum Beach homeowners for holiday lighting. We're right next door, and we're active throughout Qualicum Beach year-round on streets like Arbutus Street, Mill Road, and throughout the surrounding neighbourhoods.
            </p>
            <p>
              We handle everything, free lighting consult and mockup at your Qualicum Beach home, professional installation, seasonal colour changes, takedown, and storage at our facility. You don't lift a finger.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#F5F5F5]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Sparkles, title: "Free Consult & Mockup", desc: "We come to your Qualicum Beach property, design your display together, and show you exactly what it will look like." },
      ...
      <section className="py-24 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-zinc-600 text-lg leading-relaxed mb-16">
            ...
            <p>
              We install your lights in October with Halloween colours, orange, purple, and white. On November 1st we come back and switch to your Christmas display. Same lights, one installation, completely different look.
            </p>
            <p>It's our most popular add-on for Qualicum Beach customers who love the fall holidays. Ask us about it when you book.</p>
          </div>
      ...
      <section className="py-24 px-6 bg-[#F5F5F5]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#033852] mb-8">What Does Holiday Lighting Cost in Qualicum Beach?</h2>
            <div className="max-w-3xl mx-auto space-y-6 text-zinc-600 text-lg leading-relaxed">
              <p>
                Holiday lighting installation in Qualicum Beach starts from $500. The final price depends on the size of your home and the scope of your display.
              </p>
              <p>
          ...
          <div className="text-center">
            <p className="text-zinc-500 italic mb-10">
              Book early, Our fall schedule covers Qualicum Beach alongside Parksville and fills up fast. Most years fully booked by mid-October.
            </p>
            <a 
              href="/contact" 
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-xl border border-zinc-100">
            <div className="space-y-2">
              <AccordionItem 
                question="When should Qualicum Beach homeowners book holiday lighting?"
                answer="As early as possible, ideally by September. Our fall schedule covers Qualicum Beach alongside Parksville and fills up fast. Most years we're fully booked by mid-October. If you're thinking about it, reach out now and get on the list."
              />
              <AccordionItem 
              ...
              />
              <AccordionItem 
                question="Do you serve areas outside Qualicum Beach?"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-zinc-600 text-lg mb-8 leading-relaxed">
                We're based in Parksville, right next door to Qualicum Beach. We install holiday lights across Qualicum Beach, Parksville, Lantzville, Nanoose Bay, Coombs, Errington, Nanaimo and the surrounding area. No travel surcharges anywhere in our service area. Book early, our fall schedule fills fast.
              </p>
      ...
      <section className="bg-white py-32 px-6 text-center overflow-hidden relative border-t border-zinc-100">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-[#033852] mb-8 leading-tight">
            Ready to book your Qualicum Beach <br /> <span className="text-[#F8ABAC]">holiday lights?</span>
          </h2>
