...
export default function GutterGuardsParksville() {
  return (
    <div className="min-h-screen bg-white font-sans text-[#033852]">
      <SEO 
        title="Gutter Guard Installation Parksville BC | CoastalVille Exteriors"
        description="Professional gutter guard installation in Parksville BC. We install Alu-Rex DoublePro — lifetime clog-free warranty covering pine areas. Already working in your neighbourhood. Call (250) 270-1010."
      />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "Professional gutter guard installation in Parksville BC featuring Alu-Rex DoublePro systems."
        })}
      </script>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "Are gutter guards worth it for Parksville homes?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "For most Parksville homes — yes. With Douglas fir, pine, and arbutus trees throughout the area, gutters fill up fast. DoublePro pays for itself within a few years in avoided cleaning costs — and comes with a lifetime warranty covering pine needle areas specifically."
              }
            },
            {
              "@type": "Question",
            ...
            {
              "@type": "Question",
              "name": "How quickly can you get to a Parksville guard installation?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Typically within one to two weeks. We're locally based so there's no travel delay. Call or text (250) 270-1010 to check availability."
              }
            },
            {
              "@type": "Question",
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "DoublePro is the premium dual-layer system with microfiltration that blocks pine needles and fine debris — ideal for most Parksville homes. T-Rex is a solid entry-level single-layer system. We'll recommend the right one at the quote stage."
              }
            }
          ]
        })}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="max-w-xl text-white/80 text-sm md:text-base font-medium leading-relaxed mb-12">
              Lifetime clog-free warranty. Including pine needle areas. Already working in your neighbourhood.
            </p>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-[#033852] mb-8">Gutter Guard Installation in Parksville, By a Local Company</h2>
          <div className="space-y-6 text-zinc-600 text-lg leading-relaxed">
            <p>
              CoastalVille Exteriors is a Parksville-based exterior company installing Alu-Rex gutter guard systems on homes right here in your community. We're not driving up from Nanaimo. We live and work in Parksville, and we're active across the community year-round on properties like those on Wright Road and throughout the surrounding neighbourhoods.
            </p>
            <p>
      ...
      {/* SECTION 2 — WHY DOUBLEPRO FOR PARKSVILLE */}
      <section className="py-24 px-6 bg-[#F5F5F5]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-[#033852] mb-8 text-center">Why DoublePro Is the Right Choice for Parksville Homes</h2>
          <div className="space-y-6 text-zinc-600 text-lg leading-relaxed mb-12 text-center">
            <p>
              Parksville's Douglas fir, pine, and arbutus trees are beautiful, and brutal on gutters. Fine pine needles are the number one cause of blocked gutters in this area, and most cheap gutter guard systems let them straight through.
            </p>
            <p>
              Alu-Rex DoublePro is different. The Eclipse technology uses precision offset holes that block even fine pine needles while letting water flow freely. It's the only gutter guard system with a lifetime clog-free warranty that specifically covers pine needle areas. For Parksville homes, that's exactly what you need.
            </p>
          </div>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <div className="bg-white px-6 py-3 rounded-full shadow-sm border border-zinc-100 flex items-center gap-2 font-bold text-[#033852]">
              <Shield className="w-5 h-5 text-[#F8ABAC]" /> Lifetime Warranty
            </div>
            <div className="bg-white px-6 py-3 rounded-full shadow-sm border border-zinc-100 flex items-center gap-2 font-bold text-[#033852]">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
            <div className="bg-[#033852] p-10 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform">
                <Shield className="w-24 h-24" />
              </div>
              <h3 className="text-2xl font-bold mb-4">Alu-Rex DoublePro, Our Primary Recommendation</h3>
              <p className="text-white/80 mb-8 leading-relaxed">
                The premium option. Dual-layer microfiltration that blocks even fine pine needles and seeds. Continuous hanger that reinforces the full gutter length. Lifetime warranty including pine areas. Best for most Parksville homes where pine needle debris is a real issue.
              </p>
            ...
            <div className="bg-[#033852] p-10 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden group">
              ...
              <p className="text-white/80 mb-8 leading-relaxed">
                A solid single-layer continuous hanger system that keeps larger debris out and strengthens your gutters. A good fit for Parksville homes with minimal fine debris or tighter budgets.
              </p>
          ...
          <p className="text-center text-zinc-500 italic">
            For most Parksville homes we recommend DoublePro, the pine needle coverage and lifetime warranty make it the right call. We'll give you an honest recommendation at the quote stage.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                desc: "We start with a full gutter clean before guard installation. We want to make sure the system goes onto gutters in good shape. We can do both on the same Parksville visit."
              },
              {
                step: "Step 2",
              ...
              },
              {
                ...
                desc: "We install the guards across your full gutter system. Clean, precise, no shortcuts. Most Parksville residential installs are completed in one visit."
              }
            ].map((step, i) => (
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#033852] mb-8">What Do Gutter Guards Cost in Parksville?</h2>
            <div className="max-w-3xl mx-auto space-y-6 text-zinc-600 text-lg leading-relaxed">
              <p>
                Alu-Rex DoublePro installation starts from $500 for most Parksville residential homes. The final price depends on the linear footage of your gutters and the complexity of your roofline.
              </p>
              <p>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-12">
            <div className="bg-white p-10 rounded-3xl border border-zinc-100 shadow-sm text-center">
          ...
          <div className="text-center">
            <p className="text-zinc-500 italic mb-10">
              Free quote. We assess your gutters and give you an accurate number for your specific Parksville property.
            </p>
            <a 
              href="/contact" 
      ...
      <section className="py-24 px-6 bg-[#F5F5F5]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-bold text-[#033852] mb-16 text-center">What Parksville Homeowners Are Saying</h2>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold text-[#033852] mb-12 text-center">Common Questions from Parksville Homeowners</h2>
          <div className="space-y-2">
            <AccordionItem 
              question="Are gutter guards worth it for Parksville homes?"
              answer="For most Parksville homes, yes. With Douglas fir, pine, and arbutus trees throughout the area, gutters fill up fast. DoublePro pays for itself within a few years in avoided cleaning costs, and comes with a lifetime warranty covering pine needle areas specifically."
            />
            <AccordionItem 
            ...
            />
            <AccordionItem 
              question="How quickly can you get to a Parksville guard installation?"
              answer="Typically within one to two weeks. We're locally based so there's no travel delay. Call or text (250) 270-1010 to check availability."
            />
            <AccordionItem 
              question="What's the difference between DoublePro and T-Rex?"
              answer="DoublePro is the premium dual-layer system with microfiltration that blocks pine needles and fine debris, ideal for most Parksville homes. T-Rex is a solid entry-level single-layer system. We'll recommend the right one at the quote stage."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-32 px-6 text-center overflow-hidden relative border-t border-zinc-100">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-[#033852] mb-8 leading-tight tracking-tight uppercase">
            Ready to Stop Cleaning Your <br /> <span className="text-[#F8ABAC]">Parksville Gutters?</span>
          </h2>
          <p className="text-zinc-500 text-xl mb-12">Free quote. Lifetime warranty. Already in your neighbourhood.</p>
